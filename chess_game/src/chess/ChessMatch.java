...
public class ChessMatch {
    ...
    public ChessPiece perfotmChessMove(ChessPosition sourcePosition, ChessPosition targetPosition){
        ...
        validateTargetPositionPosition(source, target);
    ...
    public ChessPiece replacePromotedPiece(String type){
        ...
        if (!type.equals("B") && !type.equals("N") && !type.equals("R") && !type.equals("Q")) {
            throw new InvalidParameterException("Tipo inválido para ser promovido");
        }
    ...
    private void undoMove(Position source, Position target, Piece capturedPiece){
        ...
        // Desfazendo Roque Pequeno (Do lado do Rei)
        if (p instanceof King && target.getColumn() == source.getColumn() + 2) {
            Position sourceT = new Position(source.getRow(), source.getColumn() + 3);
            Position targetT = new Position(source.getRow(), source.getColumn() + 1);
        ...
        // Desfazendo Roque Grande (Do lado da Rainha)
        if (p instanceof King && target.getColumn() == source.getColumn() - 2) {
            Position sourceT = new Position(source.getRow(), source.getColumn() - 4);
            Position targetT = new Position(source.getRow(), source.getColumn() - 1);
            ChessPiece rook = (ChessPiece)board.removePiece(targetT);
    ...
    private void validateTargetPositionPosition(Position source, Position target){
